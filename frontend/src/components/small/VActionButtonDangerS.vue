<template>
    <button
        :class="[
            (propIsEnabled ? 'text-theme-light hover:shadow-sm hover:shadow-theme-soft-danger/75 hover:bg-theme-danger hover:border-theme-light-trim/30' : 'text-theme-light/10 shadow-md cursor-default'),
