<template>
    <component
        ...
        :class="[
            ...
            'block shade-text-when-hover rounded-lg transition-colors   text-theme-black    focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-theme-accent'
        ]"
