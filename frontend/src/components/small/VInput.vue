        ...
        <div class="text-lg">
            <input
                ...
                :class="[
                    ...
                    'w-full h-10 p-2 bg-theme-light border-2 border-theme-medium-gray shade-border-when-hover rounded-lg    focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-theme-black'
                ]"
            >
