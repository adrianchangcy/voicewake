        ...
        <div class="text-lg">
            ...
            <textarea
                ...
                :class="[
                    ...
                    'block w-full h-10 bg-theme-light border-2 focus:border-theme-black border-theme-medium-gray shade-border-when-hover rounded-lg overflow-hidden p-2 pt-1 transition-colors'
                ]"
