<template>
    <button
        :class="[
            ...
            'h-20 p-2 text-4xl flex items-center bg-theme-light/60       border-t-2 border-theme-light-trim rounded-lg  hover:bg-theme-light/80 hover:border-theme-light-trim/40 shadow-lg hover:shadow-md transition'
        ]"
        type="button"
