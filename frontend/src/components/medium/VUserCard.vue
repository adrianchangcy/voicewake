<template>
    <div>
        <div class="py-8 text-theme-black">
            <div class="flex flex-col gap-2 px-4 py-6 pt-4 rounded-lg border-2 border-theme-black">

                <div class="flex flex-row items-center">
                    <i class="fas fa-user text-2xl pl-2 pr-6" aria-hidden="true"></i>
                    <span class="text-2xl font-medium break-all">012345678901234567890123456789</span>
                </div>
