<template>
    ...
    >
        ...
        <div
            ref="slider"
            class="w-[99%] mx-auto h-1 absolute bg-theme-idle top-0 bottom-0 my-auto left-0 right-0 rounded-full"
        ></div>
        <div
        ...
        >
            <div
                class="w-6 h-6 rounded-full bg-theme-black top-0 bottom-0 my-auto right-0 absolute translate-x-3"
            ></div>
        </div>
    </div>
</template>
