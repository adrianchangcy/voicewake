                ...
                <div class="px-1 pb-2">
                    <div class="w-full flex flex-row items-center p-2 gap-4 border border-theme-gray-2 dark:border-dark-theme-gray-2 transition-colors shade-border-when-hover rounded-lg">
                        ...
                        >
                            ...
                            <span class="text-base font-normal text-ellipsis overflow-hidden">{{ item }}</span>
                        </VActionText>
                        ...
                        <div class="w-fit flex-shrink-0">
                            <VActionBorder
                                ...
                                prop-font-size="s"
                                prop-element="button"
                                :prop-is-enabled="isProcessing"
                                :prop-is-icon-only="isProcessing(index)"
                                type="button"
                                class="w-[7rem]"
                            >
                                <div
                                ...
                                <span v-show="!isProcessing(index)" class="mx-auto flex items-center text-center">
                                    <FontAwesomeIcon icon="far fa-circle" class="text-base"/>
