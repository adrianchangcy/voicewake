...
urlpatterns += [
    ...
    path('api/events/create/upload', apis.CreateEventsAPI.as_view(url_context="upload"), name="create_events_upload_api"),
    path('api/events/create/upload/regenerate-url', apis.CreateEventsAPI.as_view(url_context="regenerate_upload_url"), name="create_events_regenerate_upload_url_api"),
    path('api/events/create/process', apis.CreateEventsAPI.as_view(url_context="process"), name="create_events_process_api"),

    path('api/events/replies/choices/list', apis.EventReplyChoicesAPI.as_view(), name="list_event_reply_choices_api"),
    path('api/events/replies/start', apis.EventRepliesAPI.as_view(url_context="start"), name="start_replies_api"),
    path('api/events/replies/create/upload', apis.EventRepliesAPI.as_view(url_context="upload"), name="create_replies_upload_api"),
    path('api/events/replies/create/upload/regenerate-url', apis.EventRepliesAPI.as_view(url_context="regenerate_upload_url"), name="create_replies_regenerate_upload_url_api"),
    path('api/events/replies/create/process', apis.EventRepliesAPI.as_view(url_context="process"), name="create_replies_process_api"),
    path('api/events/replies/cancel', apis.EventRepliesAPI.as_view(url_context="cancel"), name="cancel_replies_api"),

    path('api/events/get/<int:event_id>', apis.GetEventsAPI.as_view(), name='get_events_api'),

    path('api/audio-clips/processings/list', apis.AudioClipProcessingsAPI.as_view(url_context="list"), name='list_audio_clip_processings_api'),
    path('api/audio-clips/processings/check/<int:audio_clip_id>', apis.AudioClipProcessingsAPI.as_view(url_context="check"), name='check_audio_clip_processings_api'),
    path('api/audio-clips/processings/delete', apis.AudioClipProcessingsAPI.as_view(url_context="delete"), name='delete_audio_clip_processings_api'),
    ...
    path('api/users/sign-up', apis.UsersLogInSignUpAPI.as_view(url_context='sign_up'), name='users_sign_up_api'),
    path('api/users/log-in', apis.UsersLogInSignUpAPI.as_view(url_context='log_in'), name='users_log_in_api'),
