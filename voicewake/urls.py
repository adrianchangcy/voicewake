...
urlpatterns += [
    ...
    path('api/users/banned-audio-clips/get/<int:page>', apis.UserBannedAudioClipsAPI.as_view(), name="user_banned_audio_clips_api"),
    path('api/audio-clip-tones/list', apis.AudioClipTonesAPI.as_view(), name='audio_clip_tones_api'),
    path('api/audio-clip-likes-dislikes', apis.AudioClipLikesDislikesAPI.as_view(), name='audio_clip_likes_dislikes_api'),
    ...
    path('reply', views.ListEventChoices.as_view(), name='list_event_choices'),
